...
var Day = function (_PureComponent) {
  ...
  Day.prototype.render = function render() {
    ...
    var _props2 = this.props,
        ...
        eventsColor = _props2$theme.eventsColor,
        year = _props2.year;
    ...
    return React.createElement(
      ...
      _extends({
        ...
        className: classNames(styles.root, (_classNames = {}, _classNames[styles.today] = isToday, _classNames[styles.event] = isEvent, _classNames[styles.highlighted] = isHighlighted, _classNames[styles.selected] = isSelected, _classNames[styles.disabled] = isDisabled, _classNames[styles.enabled] = !isDisabled, _classNames), className),
      ...
      isToday || isEvent ? React.createElement(
        'span',
        null,
        day
      ) : day,
